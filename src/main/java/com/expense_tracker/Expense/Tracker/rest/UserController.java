...
public class UserController {
    ...
    public ResponseEntity<JWTTokenDTO> loginUser(@RequestBody UserRequestDTO userRequestDTO) {
...
//        for(GrantedAuthority simpleGrantedAuthority : authenticated.getAuthorities() ) {
//            authority.append(simpleGrantedAuthority);
//            authority.append(",");
//        }
        String roles = authority.toString();
        String token="";
